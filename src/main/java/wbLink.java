...
public class wbLink {
    ...
    public static void sendWbLink(String link) throws UnsupportedEncodingException {
        ...
        try {
            ...
            WebElement elementName = new WebDriverWait(driver, 10)
                    .until(ExpectedConditions.visibilityOfElementLocated(By.className("ProfileHeader_name_1KbBs")));
            ...
            if (lines.length >= 2) {
                ...
                if (matcher.find()) {
                    ...
                    File file = new File("D:\\" + elementName.getText() + "的微博作品数");
                    ...
                    if (!file.exists()) {
                        ...
                        String filePath = "D:\\" + elementName.getText() + "的微博作品数";
